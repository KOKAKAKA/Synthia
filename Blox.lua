...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Welcome Synthia Hub!<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Thanks for using<Color=/>"):Display()
    wait(.14)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Initial Release<Color=/>"):Display()
    wait(.24)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Dev: Kia_Ainsleyy<Color=/>"):Display()
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Synthia Hub", HidePremium = false, IntroText = "Synthia Hub", SaveConfig = true, ConfigFolder = "Synthia Hub"})
...
W:AddLabel("Script By Kia_Ainsleyy")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] Welcome to Synthia Hub!")
W:AddLabel("[+] Discord: https://discord.com/invite/aqyRKwbCvT")
W:AddLabel("[+] Initial Release!")
